...
export default function Home() {
  ...
  return (
    <>
      ...
      <main className="absolute text-white z-10 w-full  h-full">
        <div>
          ...
          {/* <div className="absolute right-0 bottom-0 mb-5 mr-5 w-12 h-12 group hover:backdrop-blur-sm transform transition-transform hover:scale-110"> */}

          {/* <Image alt="network globe icon" src={Globe} className="w-12 h-12" ></Image>
            <aside><Social/></aside>
          </div> */}
